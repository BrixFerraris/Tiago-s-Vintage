    ...
    <div class="form-container">
        <form action=" " method="post" enctype=" ">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" placeholder="Address" required>
            </div>

            <div class="form-group">
                <label for="title">ContactNum:</label>
                <input type="text" id="title" name="title" placeholder="ContactNum" required>
            </div>
