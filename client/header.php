                                    ...
                                    echo '
                                        <li class="sidebar-list-item">
                                            <a href="../client/shopcart.php" id="shop-icon">
                                                ...
                                                <span class="badge" id="cart-badge">3</span> <!-- Replace 3 with dynamic content if needed -->
                                            </a>
                                        </li>';
...
#cart-badge {
    ...
    border-radius: 50%;
    font-size: 15px;
    padding: 5px 10px; /* Adjust padding for the size */
    border-radius: 50%;
    min-width: 20px; /* Ensure the badge is large enough */
    height: 25px;
}
...
#floatingButton {
    position: fixed; /* Keeps the button sticky on the screen */
    bottom: 20px; /* Position from the bottom */
    right: 20px; /* Position from the right */
    width: 60px; /* Circle button size */
    height: 60px;
    padding: 0;
    z-index: 1050; 
    margin-bottom: 50px;
    margin-right: 10px; /* Keeps it above other content */
}
...
#notificationDropdownMenu {
    min-width: 280px; /* Ensure the dropdown has a consistent size */
...
#notificationDropdownMenu .dropdown-item {
    padding: 10px; /* Add spacing for each item */
...
#drop-menu-user {
    position: absolute;
    background-color: #FFFFFF;  /* Make the dropdown white */
    border-radius: 5px; /* Rounded corners for the dropdown */
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* Soft shadow for the dropdown */
    min-width: 200px; /* Ensure the dropdown menu has a consistent width */
...
#dropdownMenuLink {
    ...
    color: #2E6600;  /* Match the text color to the navbar color */
...
#drop-menu .dropdown-item {
    padding: 10px;
    color: #2E6600;  /* Text color */
    background-color: white;  /* Ensure items have a white background */
