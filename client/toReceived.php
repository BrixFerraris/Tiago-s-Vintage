...
<head>
    ...
    <title>Order Status - To Receive</title>
...
<div class="order-status-container">
    <div class="order-tabs">
        ...
        <button class="active-tab">To Receive</button>
    ...
    <div class="order-summary">
        <p>Status: <span class="receiving-status">Awaiting Delivery</span></p>
        <p>Order Total: <span class="order-total">₱4500</span></p>
        <div class="action-buttons">
            <button class="receive-button">Mark as Received</button>
        </div>
    </div>
</div>
