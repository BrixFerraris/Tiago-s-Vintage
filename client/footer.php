    ...
    <footer>
        <div class="footerContainer">
            <div class="socialIcons">
                <a href="https://www.facebook.com/profile.php?id=100063803240125"><i
                        class="fa-brands fa-facebook"></i></a>
                <a
                    href="https://www.instagram.com/tiagos_vintage_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="><i
                        class="fa-brands fa-instagram"></i></a>
            </div>
            <div class="footerNav">
                <div class="foots">
                    <ul>
                        <li><a href="../client/landing.php">
                                <p>Home</p>
                            </a></li>
                        <li><a>
                                <p class="abtt"> About </p>
                            </a></li>
                        <li><a>
                                <p class="contt"> Contact Us </p>
                            </a></li>
...
<div class="modal-abt">
    <div class="modals">
        <h1>About Us</h1>
        <h4 class="about-us">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
